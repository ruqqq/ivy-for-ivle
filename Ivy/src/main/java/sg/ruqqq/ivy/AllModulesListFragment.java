 ...
 */
// TODO: All Modules List should be loaded from within the fragment unlike DailyModulesList
@EFragment(R.layout.fragment_daily_modules_list)
public class AllModulesListFragment extends Fragment {
    public static String TAG = "AllModulesListFragment";
    ...
    private class ModuleTimetableListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            moduleTimetableView.setVenueAndTimeVisibility(false);
